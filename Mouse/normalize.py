...
model = torch.jit.load('C:/Users/Patrik/Desktop/Projekt/AimAssistUsingAi-main/AimAssistUsingAi-main/Mouse/models/gan_models/z_size600_1.pt')
model.eval()
...
if __name__ == "__main__":
    paths=[]
    with torch.no_grad():
        generated_samples = model(torch.randn(100, 600).to(device=device))
        generated_samples = generated_samples.cpu().detach()
